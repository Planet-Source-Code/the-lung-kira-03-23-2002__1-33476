VERSION 5.00
Begin VB.Form frmTCPStatisticsV6 
   ...
   ClientTop       =   330
   ClientWidth     =   3975
   Icon            =   "frmTCPStatisticsV6.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   4335
   ScaleWidth      =   3975
   ...
   End
End
Attribute VB_Name = "frmTCPStatisticsV6"
...
Const sLocation As String = "frmTCPStatisticsV6"


Private Sub Form_Load()
On Error GoTo VB_Error
    
    If Function_Exist("iphlpapi.dll", "GetTcpStatisticsEx") = True Then
...
On Error GoTo VB_Error
    ...
    lErrors = GetTcpStatisticsEx(MIB_TCPSTATS, AF_INET6)
    If lErrors <> NO_ERROR Then
        Call Error_API(lErrors, sLocation & "\tmrTCPStatistics_Timer", "GetTcpStatisticsEx")
        tmrTCPStatistics.Enabled = False
        Exit Sub
    End If
