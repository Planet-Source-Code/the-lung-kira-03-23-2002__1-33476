...
Begin VB.Form frmIPStatisticsV4 
   ...
   End
End
Attribute VB_Name = "frmIPStatisticsV4"
...
Const sLocation As String = "frmIPStatisticsV4"
...
On Error GoTo VB_Error
    ...
    lErrors = GetIpStatistics(MIB_IPSTATS)
    If lErrors <> NO_ERROR Then
        Call Error_API(lErrors, sLocation & "\tmrIPStatistics_Timer", "GetIpStatistics")
        tmrIPStatistics.Enabled = False
        Exit Sub
    End If
