VERSION 5.00
Begin VB.Form frmUDPStatisticsV4 
   ...
   ClientTop       =   330
   ClientWidth     =   3375
   Icon            =   "frmUDPStatisticsV4.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   1695
   ScaleWidth      =   3375
   ...
   End
End
Attribute VB_Name = "frmUDPStatisticsV4"
...
Const sLocation As String = "frmUDPStatisticsV4"
...
On Error GoTo VB_Error
    ...
    lErrors = GetUdpStatistics(MIB_UDPSTATS)
    If lErrors <> NO_ERROR Then
        Call Error_API(lErrors, sLocation & "\tmrUDPStatistics_Timer", "GetUdpStatistics")
        tmrUDPStatistics.Enabled = False
        Exit Sub
    End If
